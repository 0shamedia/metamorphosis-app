...
// Contains shared types and simple components for the Setup UI

// Setup phases in order
export type SetupPhase = 'checking' | 'installing_comfyui' | 'python_setup' | 'installing_custom_nodes' | 'verifying_dependencies' | 'downloading_models' | 'finalizing' | 'complete' | 'error';
...
// Phase icons
export const PhaseIcon = ({ phase }: { phase: SetupPhase }) => {
  switch (phase) {
    case 'checking':
      return (
    ...
    case 'installing_custom_nodes': // New case
      return ( // Using python_setup icon (code brackets)
        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M9.4 16.6L4.8 12L9.4 7.4L8 6L2 12L8 18L9.4 16.6ZM14.6 16.6L19.2 12L14.6 7.4L16 6L22 12L16 18L14.6 16.6Z" fill="currentColor"/>
        </svg>
      );
    case 'verifying_dependencies': // New case
      return ( // Using checking icon (checkmark)
        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M9 16.2L4.8 12L3.4 13.4L9 19L21 7L19.6 5.6L9 16.2Z" fill="currentColor"/>
        </svg>
      );
    ...
    default: // Also for 'error' and 'complete'
      return (
        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
